            ...
            <form action="{{ route('reports.update', $report->report_id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="title" value="{{ old('title', $report->title) }}" class="form-control" placeholder="Judul">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="location" class="form-label">Lokasi</label>
                        <input type="text" name="location" value="{{ old('location', $report->location) }}" class="form-control" placeholder="Lokasi">
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control" style="height:150px" name="description" placeholder="Deskripsi">{{ old('description', $report->description) }}</textarea>
                    </div>
